...
describe("vt.wrap_text_to_fit_width", function()
  it("should correctly wrap Chinese text with specified width", function()
    local max_display_width = 132
    local text =
      "上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道"
    local expected_output = {
      "上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，",
      "不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道",
    }
  ...
  it("should correctly wrap Chinese text with specified width and '\\n' symbol", function()
    local max_display_width = 132
    local text =
      "上士闻道，勤而行之；中士闻道，若\n存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道"
    local expected_output = {
      "上士闻道，勤而行之；中士闻道，若",
      "存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道。上士闻道，勤而行",
      "之；中士闻道，若存若亡；下士闻道，大笑之，不笑不足以为道",
    }
  ...
  it("should correctly wrap text with single space", function()
    local max_display_width = 132
  ...
  it("should correctly wrap complex text with symbols and emojis", function()
    ...
    local expected_output = {
      ...
      [[。数学公式∮E·da = Q/ε₀展示∇·E=ρ/ε₀的微分形式。购物清单📋：🍎×6（$4.99）、📘×3（¥59.8/本），总价≈$4.99×6 + 59.8×3 = $29.94 + ￥179.4]],
      [[。音乐播放列表🎵：《最伟大的作品》- 周杰倫（Jay Chou） feat. 郎朗，码率320kbps@48kHz。地址示例：北京市海淀区#36号院©2023，地图坐标39]],
      [[°54'27"N 116°23'17"E。特殊符号测试：★☆☯☢☣♬♔♛⚡🔥💻✅🔍🛑🚫⚖️🔄📶📡🔑🔓💡❗❓‼️⁉️➡️⬅️↙️↗️🔀🔁🔂⏩⏪⏫⏬🎦🔅🔆🕒🕘🕧🔢🔣🔤🅰️🆎🆑🆘🆚]],
    }
